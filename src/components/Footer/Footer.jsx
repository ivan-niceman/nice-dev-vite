...
export default function Footer() {
  ...
  return (
      ...
      <div className="footer__nav">
        ...
        <ul className="footer__list-menu">
          <li className="footer__item-menu">
            <HashLink smooth className="footer__link-menu" to="#about">
              о нас
            </HashLink>
          </li>
          <li className="footer__item-menu">
            <HashLink smooth className="footer__link-menu" to="#services">
              услуги
            </HashLink>
          </li>
          <li className="footer__item-menu">
            <HashLink smooth className="footer__link-menu" to="#price">
              цены
            </HashLink>
          </li>
          <li className="footer__item-menu">
            <HashLink smooth className="footer__link-menu" to="#portfolio">
              портфолио
            </HashLink>
          </li>
        </ul>
        <ul className="contacts-list">
          <li className="contacts-item">
            <a href="https://t.me/ivan_niceman" className="footer-contacts-link" target="_blank" rel="noreferrer">
            <svg
                version="1.1"
                id="Layer_1"
                x="0px"
	...
	c2.554,1.134,3.483-1.228,3.483-1.228l6.509-33.925C46.431,6.913,44.717,6.699,43.361,7.242z"
          ...
          <li className="contacts-item">
            <a href="https://wa.me/+79775784438" className="footer-contacts-link" target="_blank" rel="noreferrer">
            <svg
          ...
          <li className="contacts-item">
            <a href="mailto:nice-dev@list.ru" className="footer-contacts-link mail-icon" target="_blank" rel="noreferrer">
            <svg
